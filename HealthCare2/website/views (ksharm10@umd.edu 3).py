...
class claimCreatForm(ModelForm):
  class Meta:
    ...
    #DateOfBirth = DateField(widget=SelectDateWidget())
    widgets = {
      'claimdate': SelectDateWidget(years=range(2010, 2017)),
        'hospitalstartdate': SelectDateWidget(years=range(2010, 2017)),
        'hospitalenddate': SelectDateWidget(years=range(2010, 2017)),
