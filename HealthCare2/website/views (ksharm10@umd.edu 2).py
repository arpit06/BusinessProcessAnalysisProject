...
class claimCreatForm(ModelForm):
  class Meta:
    ...
    #DateOfBirth = DateField(widget=SelectDateWidget())
    widgets = {
      'claimdate': SelectDateWidget(years=range(1950, 2017)),
        'hospitalstartdate': SelectDateWidget(years=range(1950, 2017)),
        'hospitalenddate': SelectDateWidget(years=range(1950, 2017)),
