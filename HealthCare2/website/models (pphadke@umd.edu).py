...
class Staff(models.Model):
    ...
    StaffRole = models.CharField(max_length=50, choices=STATUS_CHOICES, default="")
...
class Provider(models.Model):
    ...
    ProviderType = models.CharField(max_length=50, choices=STATUS_CHOICES, default="")
    NetworkType = models.CharField(max_length=50, choices=STATUS_CHOICES1, default="")
    ProviderAddress = models.CharField(max_length=50)
    City = models.CharField(max_length=50)
    ProviderState = models.CharField(max_length=50 , choices=State_choice, default="")
